...
interface PatientProps {
  ...
  patient: Patient,
  handlePatient: any,
  handleLegalProceeding: any,
}

const RegisterCouple: FC<PatientProps> = (props): JSX.Element => {
  const classes = useStyles();
  const {
    previousStep, nextStep, step, patient, handlePatient, handleLegalProceeding,
  } = { ...props };
  let flag = false;
  if (step === 1) {
    flag = true;
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={4}>
            ...
            >
              ...
              <RadioGroup aria-label="legalProceeding" name="legalProceeding" value={patient.legalProceeding} onChange={handleLegalProceeding}>
